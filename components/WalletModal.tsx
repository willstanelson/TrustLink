            ...
            {activeTab === 'profile' && (
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between bg-slate-800 p-4 rounded-xl border border-slate-700">
                        ...
                        {user?.twitter ? <button onClick={() => unlinkTwitter(user.twitter!.subject)} className="text-red-400 text-xs hover:underline">Unlink</button> : <button onClick={linkTwitter} className="bg-white text-black px-3 py-1 rounded-lg text-xs font-bold">Connect</button>}
                    </div>
                    ...
                    <div className="flex items-center justify-between bg-slate-800 p-4 rounded-xl border border-slate-700">
                        <div className="flex items-center gap-3">
                            ...
                            <div><p className="text-white font-bold text-sm">Email</p><p className="text-xs text-slate-400">{user?.email ? 'Verified' : 'Not Linked'}</p></div>
                        </div>
                        {user?.email ? <div className="text-emerald-400"><CheckCircle2 className="w-5 h-5" /></div> : <button onClick={linkEmail} className="bg-white text-black px-3 py-1 rounded-lg text-xs font-bold">Connect</button>}
                    </div>
                </div>
            )}
